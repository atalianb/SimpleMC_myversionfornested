...
#Anfw->m_a,rs->eps0
Anfw_par = Parameter("Anfw",  np.log10(5.17e-24), 0.01, (np.log10(1.0e-25), np.log10(1.0e-22)), "A_s")
rs_par =   Parameter("rs",  np.log10(4.46e-4), 0.01, (np.log10(1.0e-6), np.log10(1.0e-2)), "r_s")
phi0_par =   Parameter("phi0",  np.log10(0.61), 0.01, (np.log10(0.001), np.log10(1.0)), "phi0")
phi1_par =   Parameter("phi1",  np.log10(1.07e-2), 0.01, (np.log10(0.0001), np.log10(1.0)), "phi1")
phi2_par =   Parameter("phi2",  np.log10(0.178), 0.01, (np.log10(0.0001), np.log10(1.0)), "phi2")
