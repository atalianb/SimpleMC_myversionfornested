...
rs_par =   Parameter("rs",  np.log10(6.28e-4), 0.01, (np.log10(1.0e-6), np.log10(1.0e-1)), "r_s")
phi0_par =   Parameter("phi0",  np.log10(1.0), 0.01, (np.log10(0.0001), np.log10(3.0)), "phi0")
phi1_par =   Parameter("phi1",  np.log10(1.0e-1), 0.01, (np.log10(0.000001), np.log10(3.0)), "phi1")
phi2_par =   Parameter("phi2",  np.log10(2.22e-1), 0.01, (np.log10(0.000001), np.log10(3.0)), "phi2")
